...
public class QReviewImage extends EntityPathBase<ReviewImage> {
    ...
    private static final long serialVersionUID = -442550490L;
    ...
    public QReviewImage(Class<? extends ReviewImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new healeat.server.domain.mapping.QReview(forProperty("review"), inits.get("review")) : null;
    }
