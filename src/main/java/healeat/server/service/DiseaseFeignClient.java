...
import healeat.server.config.DiseaseFeignConfig;
...
@FeignClient(name = "disease-api-client", url = "http://apis.data.go.kr/B551182/diseaseInfoService1", configuration = DiseaseFeignConfig.class)
