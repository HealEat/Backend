...
public interface StoreApiClient {
    ...
    KakaoPlaceResponse getStoresSimply(   // 홈 화면 추천 알고리즘에 사용
                                       /* 쿼리가 없다 */
    ...
    KakaoPlaceResponse getStoresByQuery(  // 일반 검색(필터링)에 사용
    ...
    DaumImageResponse getImagesByQuery(@RequestParam String query,
                                       @RequestParam(defaultValue = "1") Integer page,
