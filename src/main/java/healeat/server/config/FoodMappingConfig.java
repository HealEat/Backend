...
public class FoodMappingConfig {
    ...
    static {
        ...
        VEGETARIAN_FOOD_ASSIGNMENT.put(Vegetarian.PESCET,Arrays.asList("한식 > 국수", "한식 > 해물/생선",
                ...
                "한식 > 냉면", "한식 > 찌개/전골", "아시아 음식 > 인도 음식", "아시아 음식 > 동남아 음식",
                "분식", "샤브샤브", "패스트푸드 > 샌드위치", "샐러드"));
        //폴로
        VEGETARIAN_FOOD_ASSIGNMENT.put(Vegetarian.POLO,Arrays.asList("한식 > 국수", "한식 > 육류/고기 > 닭요리",
                "한식 > 육류/고기 > 오리", "한식 > 해물/생선", "한식 > 수제비", "한식 > 두부전문점",
                "한식 > 한정식", "한식 > 쌈밥", "한식 > 죽", "한식 > 냉면", "한식 > 찌개/전골",
                "일식 > 초밥/롤", "아시아 음식 > 인도 음식", "아시아 음식 > 동남아 음식", "분식", "샤브샤브",
                "패스트푸드 > 샌드위치", "샐러드"));
        //락토-오보(비건과 동일)
        VEGETARIAN_FOOD_ASSIGNMENT.put(Vegetarian.LACTO_OVO,Arrays.asList("한식 > 국수", "한식 > 수제비",
                "한식 > 두부전문점", "한식 > 한정식", "한식 > 쌈밥", "한식 > 죽", "한식 > 냉면",
                "아시아 음식 > 인도 음식", "아시아 음식 > 동남아 음식 > 베트남 음식",
                "아시아 음식 > 동남아 음식 > 태국 음식", "샤브샤브", "패스트푸드 > 샌드위치", "샐러드"));
        //락토(비건과 동일)
        VEGETARIAN_FOOD_ASSIGNMENT.put(Vegetarian.LACTO,Arrays.asList("한식 > 국수", "한식 > 수제비",
                "한식 > 두부전문점", "한식 > 한정식", "한식 > 쌈밥", "한식 > 죽", "한식 > 냉면",
                "아시아 음식 > 인도 음식", "아시아 음식 > 동남아 음식 > 베트남 음식",
                "아시아 음식 > 동남아 음식 > 태국 음식", "샤브샤브", "패스트푸드 > 샌드위치", "샐러드"));
        //오보(비건과 동일)
        VEGETARIAN_FOOD_ASSIGNMENT.put(Vegetarian.OVO,Arrays.asList("한식 > 국수", "한식 > 수제비",
                "한식 > 두부전문점", "한식 > 한정식", "한식 > 쌈밥", "한식 > 죽", "한식 > 냉면",
                "아시아 음식 > 인도 음식", "아시아 음식 > 동남아 음식 > 베트남 음식",
                "아시아 음식 > 동남아 음식 > 태국 음식", "샤브샤브", "패스트푸드 > 샌드위치", "샐러드"));
        //비건
        VEGETARIAN_FOOD_ASSIGNMENT.put(Vegetarian.VEGAN,Arrays.asList("한식 > 국수", "한식 > 수제비",
                "한식 > 두부전문점", "한식 > 한정식", "한식 > 쌈밥", "한식 > 죽", "한식 > 냉면",
                "아시아 음식 > 인도 음식", "아시아 음식 > 동남아 음식 > 베트남 음식",
                "아시아 음식 > 동남아 음식 > 태국 음식", "샤브샤브", "패스트푸드 > 샌드위치", "샐러드"));
        ...
        DIET_FOOD_ASSIGNMENT.put(Diet.LOSE_WEIGHT,Arrays.asList("한식 > 삼계탕", "한식 > 해물/생선",
                "한식 > 두부전문점", "한식 > 죽", "일식 > 초밥/롤","아시아 음식 > 베트남 음식",
                "분식", "샤브샤브", "패스트푸드 > 샌드위치", "샐러드"));
        ...
        ANSWER_FOOD_AVOIDANCE.put(Answer.RAW_MEAT_FISH,Arrays.asList("한식 > 회","일식 > 참치회",
                "일식 > 초밥/롤"));
        //생선류
        ANSWER_FOOD_AVOIDANCE.put(Answer.FISH,Arrays.asList("한식 > 해물/생선","일식 > 참치회",
                "일식 > 초밥/롤"));
        //연체류(굴,조개 등)
        ANSWER_FOOD_AVOIDANCE.put(Answer.MOLLUSK,Arrays.asList("한식 > 조개","한식 > 굴/전복"));
        //매운 음식
        ANSWER_FOOD_AVOIDANCE.put(Answer.SPICY,Arrays.asList("한식 > 찌개/전골","한식 > 감자탕",
                "분식 > 떡볶이"));

        //베지테리언 - 폴로 해물/생선 중 제외 사항 리스트
        //추후에 음식점 검색 후에 제외해야할듯...
